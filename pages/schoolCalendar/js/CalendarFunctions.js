!function() {
  ...
  Calendar.prototype.drawMonth = function() {
    ...
    if(this.month) {
      ...
      this.oldMonth.addEventListener('webkitAnimationEnd', function() {
        ...
        self.drawLegend(); // Adiciona a legenda depois do mês
        window.setTimeout(function() {
  ...
  Calendar.prototype.openDay = function(el) {
    ...
    if(currentOpened && currentOpened.parentNode === el.parentNode) {
      ...
      currentOpened.addEventListener('animationend', function handler() {
        currentOpened.removeEventListener('animationend', handler);
        currentOpened.parentNode.removeChild(currentOpened);
      });

      return; // Encerra aqui para não abrir novamente
    } else {
  ...
  Calendar.prototype.drawLegend = function() {
    ...
    // Adiciona a legenda ao calendário
